<div class="customizer-links">
  <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link" id="c-pills-cctv-tab" data-bs-toggle="pill" href="#c-pills-cctv" role="tab" aria-controls="c-pills-cctv" aria-selected="false" data-original-title="">
      <div class="settings">
...
<div class="customizer-contain">
  <div class="tab-content" id="c-pills-tabContent">
    <div class="customizer-header"><i class="icofont-close icon-close"></i>
      <h5>Sidebar Bantuan</h5>
      <p class="mb-0">Enjoy <i class="fa fa-thumbs-o-up txt-primary"></i></p>
    </div>
    <div class="customizer-body pe-0 custom-scrollbar">
