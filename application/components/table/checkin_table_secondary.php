    ...
    <tr>
      ...
      <td><?php
          foreach ($data->perkara->pihak_satu as $k => $ps) {
            ++$k;
            echo form_ambil_antrian_sidang_secondary($data, "P$k", $ps->nama);
          } ?>
      </td>
    </tr>
    <tr>
      ...
      <td><?php
          foreach ($data->perkara->pihak_dua as $y => $pd) {
            ++$y;
            echo form_ambil_antrian_sidang_secondary($data, "T$y", $pd->nama);
          } ?>
      </td>
    </tr>
    <tr>
      ...
      <td><?php
          foreach ($data->perkara->pengacara_satu as $n => $ks) {
            ++$n;
            echo form_ambil_antrian_sidang_secondary($data, "KP$n", $ks->nama);
          } ?>
      </td>
    </tr>
    <tr>
